...
namespace Suntail
{
    public class PlayerInteractions : MonoBehaviour
    {
        ...
        private SuntailDoor _lookSuntailDoor;
        ...
        private void Interactions()
        {
                ...
                out interactionHit, interactionDistance, interactionLayer))
            {
                ...
                {
                    _lookSuntailDoor = interactionHit.collider.gameObject.GetComponentInChildren<SuntailDoor>();
                    ShowDoorUI();
                    if (Input.GetKeyDown(interactionKey))
                    {
                        _lookSuntailDoor.PlayDoorAnimation();
                    }
                }
            }
            else
            {
                _lookSuntailDoor = null;
                _lookObject = null;
